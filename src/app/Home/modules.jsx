                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-5 lg:gap-6">
                    ...
                    <div className="bg-white text-gray-800 p-4 sm:p-5 md:p-6 shadow-lg flex flex-col justify-between min-h-[280px] sm:min-h-[300px] md:min-h-[320px] transition-transform hover:scale-105 hover:shadow-xl">
                        <div>
                            <div className="mb-3 sm:mb-4">
                                ...
                                <h4 className="heading-blue">Edunoia Re:Fresh™ 90 Days Rebranding<br /> Sprint</h4>
                                <div className="border-line"></div>
                            </div>
                            <h6 className="title">
                    ...
                    <div className="bg-white text-gray-800 p-4 sm:p-5 md:p-6 shadow-lg flex flex-col justify-between min-h-[280px] sm:min-h-[300px] md:min-h-[320px] transition-transform hover:scale-105 hover:shadow-xl">
                        <div>
                            ...
                            <h6 className="title">
                                Boost enrollments with a clear, compelling brand story. <span style={{ visibility: 'hidden' }}>sprint sprintsprint</span>
                            </h6>
                            <p className="p-blue">
                    ...
                    <div className="bg-white text-gray-800 p-4 sm:p-5 md:p-6 shadow-lg flex flex-col justify-between min-h-[280px] sm:min-h-[300px] md:min-h-[320px] transition-transform hover:scale-105 hover:shadow-xl">
                        <div>
                            ...
                            <h6 className="title">
                                Turn alumni into lifelong ambassadors and donors. <span style={{ visibility: "hidden" }}>donors</span>
                            </h6>
                            <p className="p-blue">
                    ...
                    <div className="bg-white text-gray-800 p-4 sm:p-5 md:p-6 shadow-lg flex flex-col justify-between min-h-[280px] sm:min-h-[300px] md:min-h-[320px] transition-transform hover:scale-105 hover:shadow-xl">
                        <div>
                            <div className="mb-3 sm:mb-4">
                                <h4 className="heading-blue">
                                    Edunoia Compass™ |Brand Health Tracker<span style={{ visibility: "hidden" }}>Tracker Tracker</span>
                                </h4>
                                <div className="border-line"></div>
                            </div>
                            <h6 className="title">
                                Measure what truly matters. <span style={{ visibility: "hidden" }}>matters</span>
                            </h6>
                            <p className="p-blue">
                        ...
                        <div>
                            <div className="mb-3 sm:mb-4">
                                <h6 className="heading-blue">
                                    Edunoia Recognition Index (ERI)™ <span style={{ visibility: "hidden" }}>Index Index Index Index Index</span>
                                </h6>
                                <div className="border-line"></div>
                            </div>
                            <h6 className="title">
                    ...
                    <div className="bg-white text-gray-800 p-4 sm:p-5 md:p-6 shadow-lg flex flex-col justify-between min-h-[280px] sm:min-h-[300px] md:min-h-[320px] transition-transform hover:scale-105 hover:shadow-xl">
                        <div>
                            <div className="mb-3 sm:mb-4">
                                <h4 className="heading-blue">
                                    Edunoia Moments™ | Event Experience Branding <span style={{visibility:"hidden"}}>Branding</span>
                                </h4>
                                <div className="border-line"></div>
                            </div>
                            <h6 className="title">
