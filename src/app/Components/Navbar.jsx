            ...
            <div className="relative z-5 container mx-auto">
                <nav className="flex items-center justify-between py-4 mt-5">
                    ...
                    <ul className="hidden md:flex items-center gap-10">
                        <li className="text-white text-[20px] tracking-wide hover:opacity-70 cursor-pointer">ABOUT</li>
                        <li className="text-white text-[20px] tracking-wide hover:opacity-70 cursor-pointer">WHY EDUNOIA</li>
                        <li className="text-white text-[20px] tracking-wide hover:opacity-70 cursor-pointer">SERVICES</li>
